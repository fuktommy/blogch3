...
<li><a href="http://www.google.com/reader/link?url={$baseuri|escape:"url"}{$entry->id|escape:"url"}&amp;title={$entry->title|escape:"url"}&amp;srcURL={$baseuri|escape:"url"}&amp;srcTitle={$blogtitle|escape:"url"}" class="comments">コメントする</a></li>
